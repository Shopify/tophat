...
//  Copyright © 2022 Lukas Romsicki. Copyright © 2026 Shopify. All rights reserved.
//
...
/// when triggered.
@MainActor final class FluidMenuBarExtraStatusItem: NSObject, NSWindowDelegate {
...
// This class is not yet Sendable. We are okay with forcefully marking it
// as such for now.
extension NSStatusItem: @unchecked @retroactive Sendable {}
